 ...
 *
 * scalatestplus-play has not yet released a new version using ScalaTest 3.1.X, hence the need for a shim. Otherwise, using
 * scalatestplus-play will transitively pull in an outdated version of org/scalatest/Matchers.
 */
